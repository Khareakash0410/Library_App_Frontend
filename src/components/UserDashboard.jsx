...
useEffect(() => {
  ...
  let noOfTotalBorrowBooks = userBorrowedBooks.filter((book) => book.returned === false);

  let noOfTotalReturnBooks = userBorrowedBooks.filter((book) => book.returned === true);
  ...
  <div className="flex flex-col-reverse xl:flex-row">
    ...
    <div className="flex flex-[4] flex-col gap-7 lg:gap-16 lg:px-7 lg:py-5 justify-between xl:min-h-[85.5vh]">
       ...
       <div className="bg-white p-7 text-lg sm:text-xl xl:text-3xl 2xl:text-4xl min-h-52 font-semibold relative flex-[3] flex justify-center items-center rounded-2xl">
         <h4 className="overflow-y-hidden text-xl lg:text-2xl">"A library is not just a room full of books — <br /> it's a doorway to every dream, a map to every future, and a spark for every young mind ready to change the world."</h4>
